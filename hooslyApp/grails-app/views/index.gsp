...
<div id="content" role="main">
    <section class="row colset-2-its">
        ...
        <p>
            ...
            <br><br>
            Vendors - Vendors can manage services, appointments and payments with onboarding, subscription billing, access service requests, dashboard to accept, track and complete service requests efficiently. 
            <br><br>
