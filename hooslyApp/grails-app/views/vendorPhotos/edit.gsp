...
<html>
    ...
    <body>
        <a href="#edit-vendorPhotos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-vendorPhotos" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.vendorPhotos}" method="PUT" enctype="multipart/form-data">
