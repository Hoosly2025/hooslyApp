...
<html>
    ...
    <body>
        <a href="#show-customerPhotos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="show-customerPhotos" class="content scaffold-show" role="main">
