...
<html>
    ...
    <body>
        <a href="#edit-doc" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-doc" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.doc}" method="PUT" enctype="multipart/form-data">
                <g:hiddenField name="version" value="${this.doc?.version}" />
                <fieldset class="form">
