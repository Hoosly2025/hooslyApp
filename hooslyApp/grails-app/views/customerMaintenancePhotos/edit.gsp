...
<html>
    ...
    <body>
        <a href="#edit-customerMaintenancePhotos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-customerMaintenancePhotos" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.customerMaintenancePhotos}" method="PUT">
                ...
                <fieldset class="form">
                    <f:all bean="customerMaintenancePhotos"/>
                </fieldset>
