...
<html>
    ...
    <body>
        <a href="#show-customerSupportTicket" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="show-customerSupportTicket" class="content scaffold-show" role="main">
            <h1><g:message code="default.show.label" args="[entityName]" /></h1>
            <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
            </g:if>
            <div style="margin-left:50px;">
            Create Time: <f:display bean="customerSupportTicket" property="createTime"/><br>
            ...
            <g:form resource="${this.customerSupportTicket}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.customerSupportTicket}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
