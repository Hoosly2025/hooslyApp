...
<html>
    ...
    <body>
        <a href="#create-customerMaintenanceInvoice" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-customerMaintenanceInvoice" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.customerMaintenanceInvoice}" method="POST">
                <fieldset class="form">
